  ...
  return (
    <>
      ...
      <div className="pt-28 md:pt-40 px-5 md:px-12 text-center max-w-[1320px] mx-auto">
        ...
        <FadeUp delay={0.1}>
          <p className="text-[16px] md:text-[17px] text-text-2 max-w-[480px] mx-auto mb-8 md:mb-11 leading-[1.75]">
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-[1.15fr_0.85fr] gap-4 max-w-[1320px] mx-auto px-5 md:px-12 mb-16 md:mb-[140px]">
        {/* Terminal Card */}
        <StaggerItem className="bg-bg-dark rounded-[20px] overflow-hidden min-h-[380px] md:min-h-[480px] flex flex-col relative">
          ...
          <div className="p-5 md:p-8 font-mono text-[12.5px] md:text-[13.5px] leading-[2.2] text-white/75 flex-1 overflow-x-auto">
            ...
            <div className="pl-[22px] text-white/25 text-xs truncate">→ mycontxt.ai/kareem/my-saas-app</div>
            <div className="h-1"></div>
            ...
            <div className="pl-[22px] text-white/25 text-xs">Saved 3,388 tokens</div>
          </div>
        ...
        {/* Editorial Card */}
        <StaggerItem className="rounded-[20px] overflow-hidden min-h-[280px] md:min-h-[480px] flex items-end p-8 md:p-10 bg-gradient-to-br from-[#B8C6DB] via-[#C5D8A4] via-[#E8D5B7] to-[#D4B5D0] relative">
      ...
      <div id="features" className="py-20 md:py-[140px] px-5 md:px-12 max-w-[1320px] mx-auto space-y-16 md:space-y-24">
        ...
        <FadeUp>
          ...
          <div>
            ...
            <p className="text-[16px] md:text-[17px] text-text-2 leading-[1.75] mb-6">
              Store decisions, patterns, and active context in your project's <span className="font-mono text-[13px] md:text-[15px] bg-bg-dark/5 px-2 py-0.5 rounded">.contxt/</span> directory. One command syncs it to the cloud. Every AI tool you use can pull from it.
            </p>
        ...
        <FadeUp>
          ...
          <div className="bg-bg-dark rounded-[20px] overflow-hidden min-h-[300px] md:min-h-[420px] flex flex-col relative order-2 md:order-1">
            ...
            <div className="p-5 md:p-8 font-mono text-[12px] md:text-[13px] leading-[2] text-white/75 flex-1">
      ...
      <section className="py-20 md:py-[140px] px-5 md:px-12 bg-bg-dark">
        <div className="max-w-[1320px] mx-auto">
          <FadeUp>
              ...
              <div>
                ...
                <ul className="space-y-4 text-[14px] md:text-[15px] text-white/60">
                  <li className="flex items-start gap-3">
                    ...
                    <span>Run <span className="font-mono text-[12px] md:text-[13px] bg-white/[0.06] px-2 py-0.5 rounded text-white/80">contxt push</span> anytime during your session — decisions and patterns are saved to the cloud</span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>Run <span className="font-mono text-[12px] md:text-[13px] bg-white/[0.06] px-2 py-0.5 rounded text-white/80">contxt load</span> — get 800 tokens of the right context, not 40k of history</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#0a1a0f] border border-green-900/40 rounded-[16px] overflow-hidden">
                  ...
                  <div className="p-5 font-mono text-[12px] md:text-[13px] leading-[1.8]">
                    ...
                    <div className="text-white/25 text-[11px]">Filtered 24 irrelevant (saved 3,388 tokens)</div>
                    <div className="mt-2 text-white/40 text-[11px]">Context restored. Continue where you left off.</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="py-20 md:py-[140px] px-5 md:px-12 max-w-[1320px] mx-auto">
        ...
        <FadeUp delay={0.1}>
          ...
          <div className="px-5 md:px-6 py-2.5 md:py-3 rounded-full bg-bg-dark/5 text-text-0 text-[14px] md:text-[15px] font-semibold">GitHub Copilot</div>
          ...
          <div className="px-5 md:px-6 py-2.5 md:py-3 rounded-full bg-bg-dark/5 text-text-0 text-[14px] md:text-[15px] font-semibold">Continue</div>
        </div>
        </FadeUp>
        <FadeUp delay={0.2}>
          <div className="text-center">
      ...
      <div className="text-center py-20 md:py-[140px] px-5 md:px-12 max-w-[1320px] mx-auto">
        ...
        <FadeUp delay={0.1}>
          <p className="text-[16px] md:text-[17px] text-text-2 mb-8 md:mb-11">Stop repeating yourself. Start shipping faster.</p>
        </FadeUp>
        <FadeUp delay={0.2}>
