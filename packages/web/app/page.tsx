      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] h-16 bg-bg">
        <div className="max-w-[1320px] mx-auto px-12 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="https://github.com/kareempjackson/contxt" target="_blank" rel="noopener noreferrer" className="h-9 px-[18px] text-[13.5px] font-semibold rounded-full bg-transparent text-text-2 hover:text-text-0 transition-colors flex items-center justify-center gap-2">
